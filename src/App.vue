<template>
  <div class="wrapper">
    <!-- Sidebar  -->
    <nav id="sidebar" class="myflex-column" v-bind:class="{active: isLActive}">
      <div class="sidebar-header">
        <img style="width: 100%;" src="./assets/nineone.png">
        <h3>91CM</h3>
      </div>
    ...
    <!-- Page Content  -->
    <div id="m-wrapper" v-bind:class="{active: isLActive}">
      <header>
        <b-navbar toggleable="lg" type="light" variant="white">
          <button type="button" @click="siderbartoggle" id="sidebarCollapse" class="btn btn-info">
            <svg
              style="fill:white;"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
...
#r-sidebar {
  ...
  box-shadow: 0 15px 0 0 rgba(0, 0, 0, 0.11), 0 5px 15px 0 rgba(0, 0, 0, 0.08);
}
#r-sidebar .r-header {
  font-weight: 900;
...
.menulist-header-icon {
  flex-grow: 1;
  justify-content: flex-end;
  display: flex;
}

.menulist-header-icon a {
  display: flex;
  text-decoration: none;
  width: 17px;
}
...
#sidebar ul .menulist-header:nth-child(1) {
  padding: 0px 15px 0px 10px;
}

#sidebar ul .menulist-header {
  color: #fff;
  margin: 0px;
